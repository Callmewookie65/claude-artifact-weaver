    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-[#777]">Manage and track project budgets</p>
        </div>
        <div className="flex gap-4">
          <Button variant="outline" onClick={generateBudgetTemplate} className="border-[#eee] bg-white hover:bg-[#f5f5f5]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card-new">
          <h3 className="text-xl font-heading text-black mb-2">Total Budget</h3>
          <p className="text-2xl font-bold">{formatCurrency(totals.total)}</p>
          <p className="text-[#777] text-sm">Across all projects</p>
        </div>
        <div className="card-new">
          <h3 className="text-xl font-heading text-black mb-2">Used</h3>
          <p className="text-2xl font-bold">{formatCurrency(totals.used)} <span className="text-[#777] text-sm">({totalPercentage}%)</span></p>
        ...
        <div className="card-new">
          <h3 className="text-xl font-heading text-black mb-2">Remaining</h3>
          <p className="text-2xl font-bold">{formatCurrency(totals.remaining)}</p>
          <p className="text-[#777] text-sm">Available funds</p>
        </div>
      </div>
      ...
      <div className="card-new overflow-hidden">
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-[#f9f9f9] border-b border-[#eee]">
                <TableHead className="text-[#777]">Project</TableHead>
                <TableHead className="text-[#777]">Category</TableHead>
                <TableHead className="text-[#777] text-right">Total</TableHead>
                <TableHead className="text-[#777] text-right">Used</TableHead>
                <TableHead className="text-[#777] text-right">Remaining</TableHead>
                <TableHead className="text-[#777] text-right">%</TableHead>
                <TableHead className="text-[#777]">Currency</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {budgets.map((budget) => (
        ...
        <div className="flex justify-between items-center mt-6 pt-6 border-t border-[#eee]">
          ...
          <div className="text-right">
            <p className="text-sm font-medium">Total: <span className="text-black">{formatCurrency(totals.total)}</span></p>
